...
# Imagenes
background = pygame.image.load("images/Snake_background.png")
play_game_background = pygame.image.load("images/play_background.png")
titulo_snake = pygame.image.load("images/Titulo_Snake.png")
...
press_play_button = pygame.image.load("images/Press_Play_Button.png")
...
press_quit_button = pygame.image.load("images/Press_Quit_Button.png")
press_quit_button = pygame.transform.scale(press_quit_button, (250, 120))
sound_button = pygame.image.load("images/sound_button.png")
sound_button = pygame.transform.scale(sound_button, (60, 60))
canceled_sound_button = pygame.image.load("images/canceled_sound_button.png")
